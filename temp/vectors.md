...
Рисунок похож на иллюстрацию из школьного учебника. Учитель говорил нам, что вектор - это направленный отрезок, имеющий начало и конец. 
Перед нами вектор $ /vec{v} = 1 /vec{x} + 2 /vec{y} - 4 /vec{x} $

*Забегая немного вперед для разжигания интереса к теме, приведем пример из работы с текстом, просто для иллюстрации, сильно не забивайте им пока голову.*
