...
<h2>Введение. Основные понятия</h2>  
...
**Финальная теория**  
Неужели нам придется каждый раз высчитывать углы и косинусы между ними? Конечно, нет.  
Если векторы заданы координатами, то в момент скалярного произведения координаты с одинаковыми индексами перемножаются. Последовательность действий похожа на сложение, вычитаение и умножение вектора на число. Рассмотрим в виде формулы:  
